""" Refer to: https://kornia.readthedocs.io/en/v0.1.2/_modules/torchgeometry/contrib/spatial_soft_argmax2d.html
"""
import torch
...
def create_meshgrid(x, normalized_coordinates=True):
...
if __name__ == "__main__":
    data = torch.rand(2, 2, 3, 4) * 10
    soft_argmax = SpatialSoftArgmax2d(normalized_coordinates=False)
    coords = soft_argmax(data)  # 1x4x2
    print(data)
    print(coords)